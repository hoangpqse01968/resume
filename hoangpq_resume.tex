...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\Large Pham Quoc Hoang}} & Email : \href{mailto:hoangpqse01968@gmail.com}{hoangpqse01968@gmail.com}\\
...
\section{SKILLS}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Soft skills}
      {Problem solving, Mentoring, Time management, Collaboration}
...
\section{HONORS \& AWARDS}
  \resumeSubHeadingListStart
    ...
    %   {}
    \resumeItemWithoutHighlight
      {Nguyen Van Dao Scholarship (2010)}
    \resumeItemWithoutHighlight
      {Third prize, Vietnam Olympiad in Informatics (2010)}
    \resumeItemWithoutHighlight
      {Incentive prize, Vietnam Olympiad in Informatics (2009)}
    \resumeItemWithoutHighlight
      {Vallet Scholarship (2007,2008,2009)}
  \resumeSubHeadingListEnd
